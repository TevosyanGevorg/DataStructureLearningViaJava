package source.PSSSampleSolutions.solutions_PSS_5.stackqueue;/*
...
public class ArrayStack<E> implements Stack<E> {
     ...
     * @param times
     */
    private void resize(double times) {
        E[] temp = (E[]) new Object[(int) (data.length * times)];
        int l = Math.min(data.length, temp.length);
        for (int k = 0; k < l; k++)
            temp[k] = data[k];
